...
using Larich.Achiever.Web.Areas.Manage.ViewModels.Achiever;
...
namespace Larich.Achiever.Web.Areas.Manage.Controllers
{
    [Area("Manage")]
    public class AchieversController : Controller
    {
            ...
            public IActionResult Index(int pageIndex = 1, int pageSize = 10, string keyword = "")
            {
                ...
                Page<Larich.Achiever.Web.Infrastructures.Data.Models.Achiever> result = new Page<Larich.Achiever.Web.Infrastructures.Data.Models.Achiever>();
                if (pageSize < 1)
                {
                    pageSize = 1;
                }
                IQueryable<Larich.Achiever.Web.Infrastructures.Data.Models.Achiever> achieverQuery = (IQueryable<Larich.Achiever.Web.Infrastructures.Data.Models.Achiever>)this._context.Achievers;
                ...
                List<Larich.Achiever.Web.Infrastructures.Data.Models.Achiever> users = achieverQuery.ToList();
            ...
            public IActionResult Create(CreateViewModel model)
            {
                if (!ModelState.IsValid)
                    return View(model);
                Larich.Achiever.Web.Infrastructures.Data.Models.Achiever achiever = new Larich.Achiever.Web.Infrastructures.Data.Models.Achiever()
                {
                    Id = Guid.NewGuid(),
                    Title = model.Title,
            ...
            public async Task<IActionResult> Banner(BannerViewModel model)
            {
                ...
                var dirPath = _env.WebRootPath + "/achievers/" + model.AchieverId.ToString();
